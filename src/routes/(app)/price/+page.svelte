  <div class="w-full h-screen p-10 bg-[#dddddf]">
    <div class="text-4xl font-bold mb-10 bg-[#dddddf] text-center">
      Payment Schedule
    </div>
    ...
    <stripe-pricing-table
      pricing-table-id="prctbl_1QBEF409ae66bEMA26z1Bn1y"
      publishable-key="pk_test_51Q8cOH09ae66bEMAz3pyc7Mvp1aLsJXRuHgP1y1CgLRq5nUVUwpBNfCfsoaictQRXdHumzV9VZUc4hZWVtfbnI0e00pVitZdnP"
    >
    </stripe-pricing-table>
  </div>
